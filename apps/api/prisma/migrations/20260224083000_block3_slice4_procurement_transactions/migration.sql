...
CREATE TABLE "procurement_adjustments" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "tenant_id" TEXT NOT NULL,
    "branch_id" TEXT NOT NULL,
    ...
    "updated_at" DATETIME NOT NULL,
    "created_by" TEXT,
    CONSTRAINT "procurement_adjustments_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "procurement_adjustments_branch_id_fkey" FOREIGN KEY ("branch_id") REFERENCES "branches" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "procurement_adjustments_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);

CREATE TABLE "procurement_adjustment_lines" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "procurement_adjustment_id" TEXT NOT NULL,
    "tenant_id" TEXT NOT NULL,
    "product_id" TEXT NOT NULL,
    "inventory_movement_id" TEXT,
    ...
    "notes" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "procurement_adjustment_lines_procurement_adjustment_id_fkey" FOREIGN KEY ("procurement_adjustment_id") REFERENCES "procurement_adjustments" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "procurement_adjustment_lines_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "procurement_adjustment_lines_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "procurement_adjustment_lines_inventory_movement_id_fkey" FOREIGN KEY ("inventory_movement_id") REFERENCES "inventory_movements" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE UNIQUE INDEX "procurement_adjustments_tenant_id_adjustment_number_key" ON "procurement_adjustments"("tenant_id", "adjustment_number");
CREATE INDEX "procurement_adjustments_tenant_id_adjusted_at_idx" ON "procurement_adjustments"("tenant_id", "adjusted_at");

CREATE UNIQUE INDEX "procurement_adjustment_lines_inventory_movement_id_key" ON "procurement_adjustment_lines"("inventory_movement_id");
CREATE INDEX "procurement_adjustment_lines_tenant_id_procurement_adjustment_id_idx" ON "procurement_adjustment_lines"("tenant_id", "procurement_adjustment_id");
CREATE INDEX "procurement_adjustment_lines_tenant_id_product_id_idx" ON "procurement_adjustment_lines"("tenant_id", "product_id");
